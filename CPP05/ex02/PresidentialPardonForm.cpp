...
PresidentialPardonForm::PresidentialPardonForm(const std::string &target): Form("Presidential Pardon Form", target, 145, 137)
{
...
void	PresidentialPardonForm::executeConcrete(const Bureaucrat &executor)
{
